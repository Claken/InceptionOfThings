...
Vagrant.configure("2") do |config|
  config.vm.box = "bento/centos-7.3" # pour utiliser une box centos 7.3
  config.vm.hostname = "iot.com" # nom de la machine virtuelle
  config.vm.box_check_update = false # pour ne pas vérifier les mises à jour de la box
  config.vm.boot_timeout = 400 #  The time in seconds that Vagrant will wait for the machine to boot and be accessible. By default this is 300 seconds.
